            ...
            <div className='bg-success'>
                <Row xs={1} md={4} className="g-4">
                    <Col>
                        <h2>Follow Me</h2>
                        <br />
                        < BsFacebook className='text-white' /> <span className='text-primary fw-bold'>Facebook</span>
                        <br />
                    ...
                    <Col>
                        ...
                        <a className='text-white' href="https://mail.google.com/mail/u/0/#inbox"><AiFillMail /> abdullahsuhail43@gmail.com</a><br />
